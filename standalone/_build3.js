...
const jsDir = 'E:/360MoveData/Users/admin/Documents/小学数学自测及辅导/standalone/js';

// seed.js - 数据种子
const seedJs = `function seedData() {
...
fs.writeFileSync(path.join(jsDir, 'seed.js'), seedJs, 'utf8');
