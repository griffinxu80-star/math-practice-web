/**
 * 统一数据库模块
 * 本地开发使用 SQLite (sql.js)，生产环境使用 PostgreSQL (Supabase)
 */
...
async function pgSeedShopItems() {
  const items = [
    ...
    { id: 'shop_2', name: 'Study Certificate', description: 'Learning certificate', icon_url: '??', cost: 100 },
...
module.exports = { initDatabase, run, get, all, execMulti, seedShopItems, saveDatabase, closeDatabase };
